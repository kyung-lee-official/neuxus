...
This is a **second retrieval channel**, separate from the child-vector channel ([04-retrieval.md](./04-retrieval.md#image-description-channel)). Its hits are capped and merged into the synthesis context, labelled with the page title.
