...
Which files exist is [01-corpus.md](./01-corpus.md). Ingest turns one markdown **file** into page columns. Chunking starts after that: [03.1-chunkify.md](./03.1-chunkify.md). Embed: [embed.md](./embed.md). Query: [04-retrieval.md](./04-retrieval.md). Synthesis: [05-synthesis.md](./05-synthesis.md). Schema: [appendix-a-data-model.md](./appendix-a-data-model.md).
...
| Same markdown, new embedding model (`kb_embed_settings`) | Re-embed stale children ([embed.md](./embed.md))     |
