...
Related: [01-corpus.md](./01-corpus.md), [02-ingest.md](./02-ingest.md), [embed.md](./embed.md), [04-retrieval.md](./04-retrieval.md), [05-synthesis.md](./05-synthesis.md), [appendix-a-data-model.md](./appendix-a-data-model.md).
...
**Tree:** page →\* parent →\* child. Children never cross a parent boundary; overlap (if any) stays inside one parent. Persistence FKs and page replace-on-edit: [appendix-a](./appendix-a-data-model.md). Query expand: [04-retrieval.md](./04-retrieval.md).
