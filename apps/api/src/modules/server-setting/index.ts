 ...
 * business area (model providers, task-model map, log settings, retrieve
 * settings, corpus, nuke). Each sub-module owns its routes, schemas
 * (`model.ts`), and business logic (`service.ts`).
 */
