...
This is a **second retrieval channel**, separate from the child-vector channel ([04-retrieval.md](./04-retrieval.md#image-description-channel)). It surfaces image descriptions that match the question even when the surrounding page text does not. Its hits are capped and merged into the synthesis context, labelled with the page title.
